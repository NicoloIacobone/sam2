...
class ImageEncoder(nn.Module):
    ...
    def forward(self, sample: torch.Tensor):
        ...
        debug_vision_features_path = "/cluster/work/igp_psr/niacobone/distillation/output/distillation_5/visualizations/student/8.pt"  # Modifica questo path per il debug
        if student:
            ...
            create_student_original_teacher_side_by_side(loaded_feature, output["vision_features"], "/cluster/work/igp_psr/niacobone/examples/photos/distillation_5/000000002587.jpg", 8, "/cluster/work/igp_psr/niacobone/examples/photos/distillation_5/000000002587")
