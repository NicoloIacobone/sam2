...
class ImageEncoder(nn.Module):
    ...
    def forward(self, sample: torch.Tensor):
        ...
        student = False
        debug_vision_features_path = "/cluster/work/igp_psr/niacobone/distillation/tests/embeddings/student/000000000036.pt"  # Modifica questo path per il debug
        if student:
            ...
            create_student_original_teacher_side_by_side(loaded_feature, output["vision_features"], "/cluster/work/igp_psr/niacobone/examples/photos/distillation_4/000000000036.jpg", 0, "/cluster/work/igp_psr/niacobone/examples/photos/distillation_4/consistency_test")
