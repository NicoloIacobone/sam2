...
class ImageEncoder(nn.Module):
    ...
    def forward(self, sample: torch.Tensor):
        ...
        debug_vision_features_path = "/cluster/work/igp_psr/niacobone/distillation/output/overfit_single_image_test_5/visualizations/student/799_000000535355.pt"  # Modifica questo path per il debug
        if student:
            ...
            # create_student_original_teacher_side_by_side(loaded_feature, output["vision_features"], "/cluster/work/igp_psr/niacobone/examples/photos/distillation_7_deeper_dpt/000000002149.jpg", 6, "/cluster/work/igp_psr/niacobone/examples/photos/distillation_7_deeper_dpt/000000002149")
            ...
            if len(vision_features_shape) == 3:
                ...
                output["backbone_fpn"][-1] = loaded_feature.unsqueeze(0)
