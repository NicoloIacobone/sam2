...
show_anns(masks_1)
plt.axis('off')
output_file = os.path.join(output_path, "teacher_normal_24.png")
...
show_anns(masks_2)
plt.axis('off')
output_file = os.path.join(output_path, "teacher_no_threshold_24.png")
plt.savefig(output_file, bbox_inches='tight', pad_inches=0)
plt.close()
print(f"Saved to {output_file}")
...
show_anns(masks_3)
plt.axis('off')
output_file = os.path.join(output_path, "teacher_medium_threshold_24.png")
plt.savefig(output_file, bbox_inches='tight', pad_inches=0)
plt.close()
print(f"Saved to {output_file}")
...
show_anns(masks_4)
plt.axis('off')
output_file = os.path.join(output_path, "teacher_medium_threshold_24_mask_threshold_02.png")
plt.savefig(output_file, bbox_inches='tight', pad_inches=0)
plt.close()
print(f"Saved to {output_file}")
...
show_anns(masks_5)
plt.axis('off')
output_file = os.path.join(output_path, "teacher_medium_threshold_24_mask_threshold_neg_02.png")
plt.savefig(output_file, bbox_inches='tight', pad_inches=0)
plt.close()
